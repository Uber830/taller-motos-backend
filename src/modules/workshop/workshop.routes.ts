...
router.post('/', authMiddleware, validateRequest(createWorkshopSchema), workshopController.createWorkshop);
...
router.put('/:id', authMiddleware, validateRequest(updateWorkshopSchema), workshopController.updateWorkshop);
